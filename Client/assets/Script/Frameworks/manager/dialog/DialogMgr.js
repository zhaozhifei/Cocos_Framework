 ...
 * @LastEditTime : 2020-01-06 16:56:18
 * @LastEditors  : mengjl
 * @Description: 
...
module.exports = {
    ...
    _closeDialog(dialog_node)
    {
        ...
        PoolManager.recoveryPerfab(dialog_name, dialog_node);
    ...
    _removeDialog(dialog_node)
    {
        ...
        var maskId = dialog_comp._getMaskId();
        this._subMask(maskId);
        PoolManager.removeUsedPerfab(dialog_comp._getDialogName(), dialog_node);
    ...
    {
        var dialog_name = this._getNameById(dialog_id);
        PoolManager.getPerfab(dialog_name, (_dialog_node_) => {
            if (cc.isValid(_dialog_node_)) {
    ...
    listen(dialog_id, callback, priority = 0) 
    {
        // var dialog_name = this._getNameById(dialog_id);
